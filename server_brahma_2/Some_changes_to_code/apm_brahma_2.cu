...
// apm_brahma_2.cu
//
// APM Brahma 2 — Single-file version with all improvements
//
...
//   - Safe 50-bit prime modular multiplication (binary method)
//   - Extended group range 25–50
//   - Auto-detect GPU compute capability (in Makefile)
//
// Usage:
//   ./apm_brahma_2 [gmin gmax]
//   ./apm_brahma_2              (default: groups 25 to 50)
//   ./apm_brahma_2 32 35        (groups 32 to 35)
//   ./apm_brahma_2 25 27        (groups 25 to 27)
//   ./apm_brahma_2 35 50        (groups 35 to 50)
//
// Compile:
...
static const struct {
  ...
  long long prime;
    ...
    {40, 1099511627689LL},    {36, 68719476503LL},
    {37, 137438953097LL},  {38, 274877906837LL},   {39, 549755813657LL},
    {40, 1099511627689LL},
};
static const int NUM_HARDCODED = 31;
